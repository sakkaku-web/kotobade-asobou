...
export const t = (index: string, text1: string = '', text2: string = '') => {
  ...
  if (text1 !== '')
    translationText = translationText.replaceAll('$text1', text1);
  if (text2 !== '')
    translationText = translationText.replaceAll('$text2', text2);
...
en['HINT_MODE_DESCRIPTION'] =
  'Show three extra types of hints (circle, up and down arrows, left and right arrows).';
...
en['TIMEZONE_ALERT_MESSAGE'] =
  'Timezone can only be switched at the start of the game';
en['HINT_MODE_ALERT_MESSAGE'] =
  'Hint Mode can only be turned off at the start of the game';
en['HARD_MODE_ALERT_MESSAGE'] =
  'Hard Mode can only be turned on at the start of the game';
...
ja['Hint Mode'] = 'ヒントモード';
ja['HINT_MODE_DESCRIPTION'] =
  '三種類のヒント（丸と上下矢印と左右矢印）が追加で表示されます。';
ja['Hard Mode'] = 'ハードモード';
...
ja['NOT_ENOUGH_LETTERS_MESSAGE'] =
  '「$text1」は $text2文字の単語ではありません。$text2文字入力してください。';
ja['WORD_NOT_FOUND_MESSAGE'] = 'この答えは単語リストにありません';
ja['TIMEZONE_ALERT_MESSAGE'] =
  'タイムゾーンをゲーム開始時にのみ設定することができます';
